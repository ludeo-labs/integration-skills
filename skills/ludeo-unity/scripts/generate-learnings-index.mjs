...
// else the file's H1 title. SKILL.md's Load Learnings step loads this index first
// and uses it to decide which learning bodies to read, instead of reading every
// file per phase.
//
