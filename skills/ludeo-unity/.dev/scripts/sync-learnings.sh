...
# levels from .dev/scripts/ to reach skills/ludeo-unity/. The git commands
...
if [ -z "${SKILL_DIR:-}" ]; then
    ...
    # The installed name follows the SKILL.md frontmatter (ludeo-unity-integration);
    # also try the monorepo folder name (ludeo-unity) in case the installer uses it.
    CANDIDATES=(
        "$HOME/.claude/skills/ludeo-unity-integration"
        "${USERPROFILE:-}/.claude/skills/ludeo-unity-integration"
        "$HOME/.claude/skills/ludeo-unity"
        "${USERPROFILE:-}/.claude/skills/ludeo-unity"
        "$HOME/.claude/plugins/cache/*/skills/ludeo-unity"
        "/mnt/c/Users/*/.claude/skills/ludeo-unity-integration"
        "/mnt/c/Users/*/.claude/skills/ludeo-unity"
        "/mnt/c/Users/*/.claude/plugins/cache/*/skills/ludeo-unity"
    )
...
# --- Regenerate the learnings index (the Load step reads it; stale = new learnings invisible) ---
