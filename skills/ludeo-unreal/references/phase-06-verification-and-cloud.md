...
skill**. This phase runs that skill (installing it first if it isn't present) and adds the Unreal
...
1. **Make sure `cloud-upload` is installed.** If it isn't, install it first:
   ...
   ```
2. **Invoke the skill** and let it walk gates 1–4 in order, feeding it the Unreal specifics below. Stop
